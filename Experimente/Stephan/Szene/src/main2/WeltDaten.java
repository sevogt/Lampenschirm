...
public class WeltDaten 
{
	...
	//Setup - Zylinder
	private final float zylinder_hohe   = 0.45f; // Meter
	private final float zylinder_radius = 0.25f; // Meter
	...
	public WeltDaten(PApplet parent )
	{
		...
		testbild = parent.createGraphics(200, 200,parent.P3D);
		
		testbild.beginDraw();
		
		testbild.line(0, 30, 200, 30);
		testbild.line(0, 60, 200, 60);
		testbild.line(0, 90, 200, 90);
		testbild.line(0, 130, 200, 130);
...
//		PImage testbild = parent.loadImage("testbild.png");

		shape.beginShape(parent.TRIANGLE_STRIP);
		parent.texture(testbild);
